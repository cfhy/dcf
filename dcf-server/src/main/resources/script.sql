...
CREATE TABLE basic_balance (
    ...
    total_cash decimal (15, 2) COMMENT '总现金' ,
    ...
    fixed_asset_sum decimal (15, 2) COMMENT '固定资产合计' ,
    fixed_asset decimal (15, 2) COMMENT '固定资产' ,
    fixed_assets_disposal decimal (15, 2) COMMENT '固定资产清理' ,
    construction_in_process_sum decimal (15, 2) COMMENT '在建工程合计' ,
    ...
    fnncl_liab_profit_and_loss_gyjzjl decimal (15, 2) COMMENT '以公允价值计量且其变动计入当期损益的金融负债' ,
    ...
    lt_payable_sum decimal (15, 2) COMMENT '长期应付款合计' ,
    lt_payable decimal (15, 2) COMMENT '长期应付款' ,
    estimated_liab decimal (15, 2) COMMENT '预计负债' ,
    noncurrent_liab_di decimal (15, 2) COMMENT '递延收益-非流动负债' ,
    dt_liab decimal (15, 2) COMMENT '递延所得税负债' ,
