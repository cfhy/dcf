...
public class BalanceSheetEntity {
    ...
    private BigDecimal AVAILABLE_SALE_FINASSET;
    ...
    @Column(name = "合同资产")
    private BigDecimal CONTRACT_ASSET;
    ...
    @Column(name = "固定资产清理")
    private BigDecimal FIXED_ASSET_DISPOSAL;
    ...
    @Column(name = "持有至到期投资")
    private BigDecimal HOLD_MATURITY_INVEST;
    @Column(name = "持有待售资产")
    ...
    @Column(name = "投资性房地产")
    private BigDecimal INVEST_REALESTATE;
    ...
    private BigDecimal NONCURRENT_ASSET_1YEAR;
    ...
    private BigDecimal OTHER_COMPRE_INCOME;
    @Column(name = "其他债权投资")
    ...
    private BigDecimal OTHER_EQUITY_INVEST;
    ...
    private BigDecimal OTHER_NONCURRENT_FINASSET;
    ...
    private BigDecimal PROJECT_MATERIAL;
