export const stockData = {
	...
	item: {
		...
		ncfFromOaList: {
			...
			title: '第14步：看经营活动产生的现金流量净额',
			bodyList: [
				'看经营活动产生的现金流量净额，了解公司的造血能力',
				'1、经营活动产生的现金流量净额必须大于等于0，越大越好；小于0，直接淘汰。',
				'2、经营活动产生的现金流量净额增长率大于等于0，意味着公司的造血能力在增强；小于0，意味着公司的造血能力在下降。'
			],
		},
		futureGroupList: {
			columnList: [{
			...
			title: '第15步：看购建固定资产、无形资产和其他长期资产支付的现金',
			bodyList: [
